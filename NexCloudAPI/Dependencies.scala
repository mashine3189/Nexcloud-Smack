...
object Dependencies {
  ...
  val akka =                    "com.typesafe.akka" %% "akka-stream-kafka" % "0.16"
  val akkaConsumer   = "org.apache.kafka" % "kafka-clients" % "0.11.0.0"
  val kafkaStreaming = "org.apache.kafka" % "kafka-streams" % "0.11.0.0"
  val akkaStream  = "com.typesafe.akka" %% "akka-stream" % akkaHttpVersion
  val akkaStreamKafka = "com.typesafe.akka" %% "akka-stream-kafka" % "0.11-RC1"
  val akkaActor   = "com.typesafe.akka" %% "akka-actor" % akkaHttpVersion
  val zClient		= "com.101tec" % "zkclient" % "0.3"
}